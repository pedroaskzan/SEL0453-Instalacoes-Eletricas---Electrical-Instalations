...
*Feedback/corrections: should've calculated the short-circuit currents; should've drawn with better quality the single-line diagrams - using AutoCAD solves it better; should've presented coordination and seletivity: i should've shown clearly the strategy used: selecting protection to act firstly to activate on less current, w/ faster activation time and closer to the connected circuit.

Step4: Summarization of everything developed for the work in the discipline.
